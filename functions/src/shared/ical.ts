...
//
// Authored here and copied to src/lib/ical.ts so a future client "download .ics"
// preview and the email Cloud Function emit identical calendar files. The client
// calendarInvite() stub wraps this.
//
